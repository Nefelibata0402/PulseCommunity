...
const (
	// Verify that this generated returnCode is sufficiently up-to-date.
...
type LoginResponse struct {
	...
	StatusMsg  string        `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty"`
	UserId     int64         `protobuf:"varint,3,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	Token      *TokenRequest `protobuf:"bytes,4,opt,name=token,proto3" json:"token,omitempty"`
}
...
func (x *LoginResponse) GetToken() *TokenRequest {
	if x != nil {
		return x.Token
	}
	return nil
...
func (x *TokenRequest) GetTokenType() string {
	if x != nil {
		return x.TokenType
	}
	return ""
...
func (x *TokenRequest) GetAccessTokenExp() int64 {
	if x != nil {
...
var file_service_proto_rawDesc = []byte{
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x74, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	...
	0x69, 0x72, 0x6d, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x81, 0x01, 0x0a, 0x10,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x92, 0x01,
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x28, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65,
	0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x54,
	0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x05, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x22, 0x9a, 0x01, 0x0a, 0x0c, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75,
	...
	0x12, 0x36, 0x0a, 0x09, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x41, 0x75, 0x74, 0x68, 0x12, 0x12, 0x2e,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x1c, 0x5a, 0x1a, 0x75, 0x73, 0x65, 0x72,
...
var file_service_proto_goTypes = []interface{}{
	...
	(*TokenRequest)(nil),     // 4: usergrpc.TokenRequest
}
var file_service_proto_depIdxs = []int32{
	4, // 0: usergrpc.LoginResponse.token:type_name -> usergrpc.TokenRequest
	0, // 1: usergrpc.UserService.Register:input_type -> usergrpc.RegisterRequest
	2, // 2: usergrpc.UserService.Login:input_type -> usergrpc.LoginRequest
	2, // 3: usergrpc.UserService.TokenAuth:input_type -> usergrpc.LoginRequest
	1, // 4: usergrpc.UserService.Register:output_type -> usergrpc.RegisterResponse
	3, // 5: usergrpc.UserService.Login:output_type -> usergrpc.LoginResponse
	3, // 6: usergrpc.UserService.TokenAuth:output_type -> usergrpc.LoginResponse

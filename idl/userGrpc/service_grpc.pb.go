...
type UserServiceClient interface {
	...
	TokenAuth(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error)
}
...
func (c *userServiceClient) TokenAuth(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
...
type UserServiceServer interface {
	...
	TokenAuth(context.Context, *LoginRequest) (*LoginResponse, error)
...
func (UnimplementedUserServiceServer) TokenAuth(context.Context, *LoginRequest) (*LoginResponse, error) {
...
func _UserService_TokenAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).TokenAuth(ctx, req.(*LoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
